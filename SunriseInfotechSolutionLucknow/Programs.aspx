<%@ Page Title="SIS | Programs" Language="C#" MasterPageFile="~/Landing.Master" AutoEventWireup="true" CodeBehind="Programs.aspx.cs" Inherits="SunriseInfotechSolutionLucknow.Programs" %>
    ...
    <section class="programs"  style="width:100%;text-align: justify; margin-top: 6%;">
        ...
        <div class="about-flex ">
            ...
            <div class="about-sections">
                ...
                <ul>
                    ...
                    <li>Chance to put one’s skills into practice and gain more confidence in a working environment</li>
        ...
        <div class="about-flex">
            ...
            <div class="about-sections">
                <ul>
                    ...
                    <li>Python using Django and flask.</li>
                </ul>
            </div>
        </div>
        <div class="about-sections w-100">
            ...
            <ul>
                ...
                <li>Advance Enbedded System</li>
                <li>Robotics</li>
                <li>VHDL</li>
                <li>Verihol DHL</li>
                <li>PCB & Circuit Design</li>
                <li>Wireless and Telecome</li>
                <li>LINUX and RTOX</li>
        ...
        <div class="about-flex">
            ...
            <div class="about-sections">
                <ul>
                    <li>CATIA Training</li>
                    <li>3D-Max Training</li>
                    <li>PRIMAVERA Training</li>
                    <li>PRO - E Training</li>
                    <li>Autocad(2d & 3d )Training</li>
                    <li>Staad Pro Training</li>
                    <li>SOLIDWORKS Training</li>
                    <li>REVIT MEP Training</li>
        ...
        <div class="about-flex">
            <div class="about-sections">
                <ul>
                    ...
                    <li>RTOS Training</li>
                    <li>ERP Training</li>
                    <li>P SPICE Training</li>
                    <li>MATLAB Training</li>
                    <li>Perl Training</li>
                    <li>Industrial Automation</li>
                    <li>VLSI Training</li>
                    <li>System Verilog Structure</li>
                </ul>
            </div>
            <div class="about-sections">
                <h5>Students: </h5>
